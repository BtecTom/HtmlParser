...
public class ReportGeneratorTests
{
    ...
    public Task<bool> ParserTest_UnableToGetReportSubjectsName(IReportGenerator reportGenerator, string rawHtml)
    {
    ...
    public Task<bool> ParserTest_UnableToGetReportEntityType(IReportGenerator reportGenerator, string rawHtml)
    {
        Assert.ThrowsAsync<MandatoryFieldNotFoundException>(
            async Task () => await reportGenerator.GenerateReportObjectFromHtmlString(rawHtml),
